...
with open(r'C:\Users\cwest\.gemini\antigravity\scratch\shift\app\src\main\java\com\example\shift\ui\runner\RunnerScreen.kt', 'r', encoding='utf-8') as f:
    content = f.read()

new_active_runner = '''@Composable
                    ...
                    androidx.compose.foundation.Canvas(modifier = Modifier.fillMaxSize()) {
                        ...
                        if (sweep > 0f) {
                            for (i in 0..sweep.toInt()) {
                                ...
                                val x = center.x + currentRadius * kotlin.math.cos(rad)
                                val y = center.y + currentRadius * kotlin.math.sin(rad)
...
content = re.sub(r'@Composable\s+fun ActiveRunnerScreen\(.*?\n}\n', new_active_runner + '\n', content, flags=re.DOTALL)

with open(r'C:\Users\cwest\.gemini\antigravity\scratch\shift\app\src\main\java\com\example\shift\ui\runner\RunnerScreen.kt', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated RunnerScreen.kt")
